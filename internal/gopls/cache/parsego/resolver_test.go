...
import (
	...
	"github.com/conductorone/plaid-lint/internal/gopls/internal/testenv"
)
...
func TestGoplsSourceDoesNotUseObjectResolution(t *testing.T) {
	...
	exceptions := []string{
		...
		"github.com/conductorone/plaid-lint/internal/gopls/analysis/simplifyslice",           // restrict ourselves to one blessed analyzer
		"github.com/conductorone/plaid-lint/internal/gopls/cache/parsego",                    // used by parsego.File.Resolve, of course
		"github.com/conductorone/plaid-lint/internal/gopls/golang.builtinDecl",               // the builtin file is resolved
		"github.com/conductorone/plaid-lint/internal/gopls/golang.NewBuiltinSignature",       // ditto
		"github.com/conductorone/plaid-lint/internal/gopls/golang/completion.builtinArgKind", // ditto
		"github.com/conductorone/plaid-lint/internal/gopls/internal/imports",                                // goimports does its own parsing
